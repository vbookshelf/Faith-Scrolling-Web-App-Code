...
When I saw how smooth and fast the video playback worked I realized that an opportunity exists to disconnect the physical act of scrolling from toxic social media algorithms by giving people the ability to create personalized short-video playlists, which they can then scroll through using browser-based video players. 
