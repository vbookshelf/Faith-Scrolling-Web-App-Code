...
- The main weakness of this concept is that it relies on a third party platform (YouTube) where videos are created and hosted. The risk is that, at any time, the platform could change it's terms of service regarding embedding YouTube Shorts. That change could impact all web apps that use iframes to display YouTube short videos. Those changes could be neagative, but they could also be positive if, for example, YouTube gave video creators finer grained control over which web apps could embed their content.
